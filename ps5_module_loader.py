...
class Dynamic:
    ...
    def tag(self):
        ...
        return Dynamic.NAMES.get(self.TAG, 'DT_UNKNOWN_%
    ...
    def lib_attribute(self):
        ...
        }.get(self.VALUE & 0xFFFFFFFF, 'Attributes:%
...
class Relocation:
    ...
    def type(self):
        ...
        return Relocation.NAMES.get(self.CODE, 'Missing PS5 Relocation Type!!! (%
...
PS5_SYSCALLS = [
        ...
        'compat.gethostname', 'compat.sethostname', 'getdtablesize', 'dup2', '
        ...
        'gettimeofday', 'getrusage', 'getsockopt', '
        ...
        'obs_{', 'compat.quota', 'compat.getsockname', '
        'compat.getdirentries', 'compat4.statfs', 'compat4.fstatfs', '
        'compat4.getdomainname', 'compat4.setdomainname', 'compat4.uname', 'sysarch', 'rtprio', '
        'semsys', 'msgsys', 'shmsys', '
        '
        'pathconf', 'fpathconf', '
        'compat6.lseek', 'compat6.truncate', 'compat6.ftruncate', '__sysctl', 'mlock', 'munlock', 'obs_{',
        'futimes', 'getpgid', '
        'lkmnosys', 'lkmnosys', 'lkmnosys', 'lkmnosys', 'lkmnosys', 'compat7.__semctl', 'semget', 'semop', '
        ...
        'ffclock_getestimate', '
        'rfork', 'obs_{', 'issetugid', 'lchown', 'aio_read', 'aio_write', 'obs_{', '
        '
        'lchmod', 'netbsd_lchown', 'lutimes', 'netbsd_msync', 'obs_{', 'obs_{', 'obs_{', '
        '
        '
        ...
        'obs_{', '__mac_execve', 'sigaction', 'sigreturn', '
        ...
        'kmq_timedsend', 'kmq_notify', 'kmq_unlink', 'obs_{', 'thr_set_name', 'aio_fsync', 'rtprio_thread', '
        '
        ...
        'localtime_to_utc', 'set_uevt', 'get_cpu_usage_proc', 'get_map_statistics', 'set_chicken_switches', '
        '
        ...
        'procctl', 'ppoll', 'futimens', 'utimensat', 'numa_getaffinity', 'numa_setaffinity', '
        '
